...
PRODUCT_NAME        = cURL_Easy_PS3.a


#################################################################
SOURCES				= Plugin.cpp scurl.cpp 
...
USER_LIBRARIES		= 
USER_FLAGS			= 
COMMONFLAGS			= -Os -g0 -Wno-unknown-pragmas -fPIC -fsigned-char -fno-strict-aliasing -D__PS3__ -D_GNU_SOURCE -DHAVE_STDINT_H $(USER_FLAGS) -I$(SRCROOT) -I$(SRCROOT)/PS3 -I$(S3DXROOT) -I$(CELL_SDK)/target/ppu/include $(USER_INCLUDE_PATH)
CFLAGS      		= -std=c99
